...
var ReactHigherEventProxy = function (_Component) {
  ...
  function ReactHigherEventProxy(props) {
    _classCallCheck(this, ReactHigherEventProxy);

    var _this = _possibleConstructorReturn(this, (ReactHigherEventProxy.__proto__ || Object.getPrototypeOf(ReactHigherEventProxy)).call(this, props));
  ...
  _createClass(ReactHigherEventProxy, [{
    ...
    value: function getEventProps() {
      ...
      var eventProps = {};
      higherEventProxy.events.forEach(function (value, key) {
        eventProps[key] = function (event) {
          if (_this2.props[key]) {
            _this2.props[key](event);
          }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        _extends({}, props, this.getEventProps(), { ref: this.setRef }),
        children
      );
    }
  }]);
